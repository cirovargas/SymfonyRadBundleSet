...
namespace Core\AlertBundle\Services;

use Core\AlertBundle\Entity\Alert;
use Core\AlertBundle\Entity\UserAlert;
...
class AlertService {
    ...
    public function alertUsers($system,$text,$url,$icon,$users,$level){
        if(empty($users)){
    ...
    private function sendAlert($system,$text,$url,$icon,$users,$level = 'default'){
